  ...
  return (
    ...
    >
      ...
      <header className="z-30 flex w-full max-w-7xl items-center justify-between">
        ...
        >
          <span className="font-pirata text-2xl">{logoText}</span>
        </motion.div>
      ...
      <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center md:grid-cols-3">
        ...
        >
          ...
          <a
            href={readMoreLink}
            className="mt-6 inline-block rounded-full bg-foreground px-8 py-3 text-sm font-medium text-background transition-transform hover:scale-105 active:scale-95"
          >
            GET STARTED
          </a>
        </motion.div>
        ...
        <div className="relative order-1 md:order-2 flex justify-center items-center h-full">
          ...
          <motion.img
            ...
            onError={(e) => {
              ...
              target.onerror = null;
              target.src = 'https://placehold.co/400x600/eab308/ffffff?text=MU8IC';
            }}
          />
        </div>
        ...
        >
          <h1 className="font-pirata text-7xl text-foreground md:text-8xl lg:text-9xl leading-[0.9]">
            {overlayText.part1}
            <br />
            {overlayText.part2}
          </h1>
