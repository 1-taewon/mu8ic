...
const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(({ className, ...props }, ref) => (
    <textarea
        className={cn(
            ...
            "scrollbar-thin scrollbar-thumb-[#444444] scrollbar-track-transparent hover:scrollbar-thumb-[#555555]",
            className
        )}
        ref={ref}
        rows={1}
            ...
            <TooltipProvider>
                ...
                >
                    <div
                        ref={ref}
                        className={cn(
                            "rounded-[32px] border border-white/5 bg-[#1a1a1a] p-4 shadow-2xl transition-all duration-300",
                            isLoading && "border-purple-500/30",
                            className
                        )}
...
export const PromptInputBox = forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
        ...
        <>
            ...
            >
                ...
                >
                    <PromptInputTextarea
                        placeholder={placeholder}
                        className="text-sm text-white/50 placeholder:text-white/20 min-h-[40px]"
                    />
                </div>
                ...
                <PromptInputActions className="flex items-center justify-between gap-2 px-2 pt-2">
                    <div
                        className={cn(
